-- Working from this database always 
USE lab_mysql;

-- 1) Inserting columns and values into "cars" table
 -- Every VALUE inside ' except the year
 -- This will give an error message because the VIN number is UNIQUE, and the last two numbers are duplicate
 -- VIN numbers were given in the lab, we will need to proceed with NSERT IGNORE
